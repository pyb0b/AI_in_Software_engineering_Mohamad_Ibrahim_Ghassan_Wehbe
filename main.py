...
# Evaluate models
evaluator = ModelEvaluator(user_item_matrix, movies_df, svd_model=svd_model, knn_model=knn_model)
...
#evaluator.evaluate_knn(sample_user_id)
# Filter the test data for the specific user
user_test_data = test_data[test_data['userId'] == sample_user_id]

# Ensure the filtered data is not empty before calling evaluate_knn
